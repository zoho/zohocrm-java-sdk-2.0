...
public class Constants
{
    ...
    public static final ArrayList<String> IS_GENERATE_REQUEST_BODY = new ArrayList<String>(Arrays.asList(Constants.REQUEST_METHOD_PATCH, Constants.REQUEST_METHOD_POST, Constants.REQUEST_METHOD_PUT));
    ...
    public static final String PHOTO_UPLOAD_ERROR_MESSAGE  = "The given module is not supported in API.";
